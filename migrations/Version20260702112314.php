 ...
 */
final class Version20260702112314 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE package (id INT AUTO_INCREMENT NOT NULL, description VARCHAR(255) NOT NULL, name VARCHAR(100) NOT NULL, price DOUBLE PRECISION NOT NULL, created_at DATETIME NOT NULL, photo VARCHAR(255) NOT NULL, business_id INT NOT NULL, category_id INT NOT NULL, INDEX IDX_DE686795A89DB457 (business_id), INDEX IDX_DE68679512469DE2 (category_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
